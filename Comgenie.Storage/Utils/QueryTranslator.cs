...
namespace Comgenie.Storage.Utils
{
    ...
    public class QueryTranslator<T> : IQueryProvider, IOrderedQueryable<T> 
    {
        ...
        public TResult Execute<TResult>(Expression expression)
        {
            ...
            var simple = translator.Translate(evaluatedExpression);
            ...
            return (TResult)((object)newRoot.FirstOrDefault());
        }
    }
            ...
            else if (q == null)
            {
                switch (Type.GetTypeCode(c.Value.GetType()))
                {
                    ...
                    case TypeCode.DateTime:
                        ...
                        sb.Append(dateTime.ToString("yyyy-MM-dd'T'HH:mm:ssK", CultureInfo.InvariantCulture)); // change to O to include miliseconds
                        sb.Append("'");
                        break;
